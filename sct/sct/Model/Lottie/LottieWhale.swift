...
struct LottieWhale: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieWhale>) -> UIView {
        //3.
...
//        animationView.play()
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieWhale>) {
        // do nothing
    }
