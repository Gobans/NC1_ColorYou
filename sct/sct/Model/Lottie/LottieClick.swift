...
struct LottieClick: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieClick>) -> UIView {
        //3.
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieClick>) {
        // do nothing
    }
