...
struct LottieBurning: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieBurning>) -> UIView {
        //3.
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieBurning>) {
        // do nothing
    }
