...
struct LottieStreet: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieStreet>) -> UIView {
        //3.
...
//        animationView.play()
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieStreet>) {
        // do nothing
    }
