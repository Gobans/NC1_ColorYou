...
struct LottieTyping: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieTyping>) -> UIView {
        //3.
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieTyping>) {
        // do nothing
    }
