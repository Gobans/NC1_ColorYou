...
struct LottieBubble: UIViewRepresentable {
    ...
    func makeUIView(context: UIViewRepresentableContext<LottieBubble>) -> UIView {
        //3.
    ...
    func updateUIView(_ uiView: UIView, context: UIViewRepresentableContext<LottieBubble>) {
        // do nothing
    }
